...
# the first five epochs. See https://arxiv.org/abs/1706.02677 for detail
...
if __name__ == '__main__':
    ...
    train_dataset = datasets.CIFAR10(args.train_dir, train = True, download = True, transform = transform)
    ...
    val_dataset = datasets.CIFAR10(args.val_dir, download = True, transform = transform)
